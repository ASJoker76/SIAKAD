...
public class ListGuruActivity extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterDataGuru(ListGuruActivity.this, listData);
    ...
    private void callData() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_data, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ListGuruActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, PertemuanMatpelSiswaActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ListGuruActivity.this, SiswaActivity.class);
        intent.putExtra(Server.TAG_ID, ids);
        intent.putExtra(Server.TAG_USERNAME, username);
        intent.putExtra(Server.TAG_NIS, nis);
        intent.putExtra(Server.TAG_NAMA, nama);
