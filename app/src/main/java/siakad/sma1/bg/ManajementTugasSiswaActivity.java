...
public class ManajementTugasSiswaActivity extends AppCompatActivity implements ListView.OnItemClickListener{

    Button btn_logout;
    TextView txt_id, txt_username;
    String idg, namag, matpel;
    ...
    String ids, nis,nama,kelas,jurusan,username,nip;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manajement_tugas_siswa);
        ...
        adapter = new AdapterTugasSiswa(ManajementTugasSiswaActivity.this, listData);
    ...
    private void callData(final String nip) {
        ...
        pDialog = new ProgressDialog(ManajementTugasSiswaActivity.this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, ManajementDisplayTugasSiswaActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ManajementTugasSiswaActivity.this, ListTugasSiswaActivity.class);
        intent.putExtra(Server.TAG_ID, ids);
        intent.putExtra(Server.TAG_USERNAME, username);
        intent.putExtra(Server.TAG_NIS, nis);
        intent.putExtra(Server.TAG_NAMA, nama);
