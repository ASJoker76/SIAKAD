...
public class InsertAbsensiActivity extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_absensi);
        ...
        adapter = new AdapterDataSiswa(InsertAbsensiActivity.this, listData);
    ...
    private void callData() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_data, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(InsertAbsensiActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, UpdateAbsensiActivity.class);
    ...
    private void cariData(final String keyword,final String keyword2) {
        ...
        pDialog = new ProgressDialog(InsertAbsensiActivity.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(InsertAbsensiActivity.this, GuruActivity.class);
