...
public class DisplayDokumentSiswaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_dokument_siswa);
    ...
    private void init(String file) {
        ...
        pDialog = new ProgressDialog(DisplayDokumentSiswaActivity.this);
