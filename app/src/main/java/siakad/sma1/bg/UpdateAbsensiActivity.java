...
public class UpdateAbsensiActivity extends AppCompatActivity {
    ...
    private String url = Server.URL + "insert_absensi.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_absensi);
    ...
    private void updateEmployee(){
        ...
        String namaguru = txt_namaguru.getText().toString();
        String matapel = txt_matapel.getText().toString();
        String ketabsen = String.valueOf(kethadir.getSelectedItem());
        ...
        if (conMgr.getActiveNetworkInfo() != null
                && conMgr.getActiveNetworkInfo().isAvailable()
                && conMgr.getActiveNetworkInfo().isConnected()) {
            checkAbsen(nis,namasiswa,nip,namaguru,matapel,tgl,ketabsen,validasi);
        } else {
    ...
    private void checkAbsen(final String nis, final String namasiswa, final String nip, final String namaguru, final String matapel, final String tgl, final String ketabsen, final String validasi) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("tgl", tgl);
                params.put("ketabsen", ketabsen);
                params.put("validasi", validasi);
                return params;
            }
