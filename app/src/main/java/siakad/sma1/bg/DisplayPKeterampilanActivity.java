...
import siakad.sma1.bg.adapter.AdapterNilaiDll;
...
public class DisplayPKeterampilanActivity extends AppCompatActivity {
    ...
    List<DataModel> listData4 = new ArrayList<DataModel>();

    AdapterNilaiLisan adapter;
    AdapterNilaiTulisan adapter2;
    AdapterNilaiPenugasan adapter3;
    AdapterNilaiDll adapter4;

    String id, nis,nama,kelas,jurusan,username;
    TextView txt_id, txt_nis, txt_nama,txt_kelas,txt_jurusan;
    ListView list_view,list_view2,list_view3,list_view4;
    Spinner txt_matpel;
    String selectedItem;

    public static final String url_cari = Server.URL + "penilaian_unjukkerja.php";
    public static final String url_cari2 = Server.URL + "penilaian_proyek.php";
    public static final String url_cari3 = Server.URL + "penilaian_produk.php";
    public static final String url_cari4 = Server.URL + "penilaian_portofolio.php";

    public static final String url_update = Server.URL + "penilaian_update_unjukkerja.php";
    public static final String url_update2 = Server.URL + "penilaian_update_proyek.php";
    public static final String url_update3 = Server.URL + "penilaian_update_produk.php";
    public static final String url_update4 = Server.URL + "penilaian_update_portofolio.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_p_keterampilan);
        ...
        list_view4 = (ListView) findViewById(R.id.listView4);

        adapter = new AdapterNilaiLisan(DisplayPKeterampilanActivity.this, listData);
        adapter2 = new AdapterNilaiTulisan(DisplayPKeterampilanActivity.this, listData2);
        adapter3 = new AdapterNilaiPenugasan(DisplayPKeterampilanActivity.this, listData3);
        adapter4 = new AdapterNilaiDll(DisplayPKeterampilanActivity.this, listData4);

        list_view.setAdapter(adapter);
        list_view2.setAdapter(adapter2);
        list_view3.setAdapter(adapter3);
        list_view4.setAdapter(adapter4);
    ...
    private void loadnilaidll(final String nis) {
        adapter4.notifyDataSetChanged();

        StringRequest strReq = new StringRequest(Request.Method.POST, url_cari4, new Response.Listener<String>() {
    ...
    private void loadnilaidll2(final String nis,final String matpel) {
        listData4.clear();
        adapter4.notifyDataSetChanged();

        StringRequest strReq = new StringRequest(Request.Method.POST, url_update4, new Response.Listener<String>() {
...
/*
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DisplayPKeterampilanActivity.this, DasbordNilaiSiswaActivity.class);
