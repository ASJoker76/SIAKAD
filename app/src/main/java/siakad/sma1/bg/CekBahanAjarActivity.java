...
public class CekBahanAjarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cek_bahan_ajar);
    ...
    public void pindah(View view) {
        switch (view.getId()) {
            case R.id.btn_foto:
                Intent intent = new Intent(CekBahanAjarActivity.this, DisplayFotoActivity.class);
                intent.putExtra("file", txt_foto.getText().toString());
                //finish();
                startActivity(intent);
                break;
            case R.id.btn_docx:
                Intent intent2 = new Intent(CekBahanAjarActivity.this, DisplayDokumentActivity.class);
                intent2.putExtra("file", txt_word.getText().toString());
                //finish();
                startActivity(intent2);
                break;
            case R.id.btn_pdf:
                Intent intent3 = new Intent(CekBahanAjarActivity.this, DisplayDokumentActivity.class);
                intent3.putExtra("file", txt_pdf.getText().toString());
                //finish();
                startActivity(intent3);
                break;
            case R.id.btn_video:
                Intent intent4 = new Intent(CekBahanAjarActivity.this, DisplayVideoActivity.class);
