...
public class DisplayAbsensiActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_absensi);
        ...
        adapter = new AdapterAbsensiSiswa(DisplayAbsensiActivity.this, listData);
    ...
    private void cariData(final String keyword) {
        ...
        pDialog = new ProgressDialog(DisplayAbsensiActivity.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DisplayAbsensiActivity.this, SiswaActivity.class);
