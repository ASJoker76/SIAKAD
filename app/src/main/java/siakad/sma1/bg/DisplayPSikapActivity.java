...
public class DisplayPSikapActivity extends AppCompatActivity {
    ...
    public static final String url_cari = Server.URL + "penilaian_observasi.php";
    public static final String url_cari2 = Server.URL + "penilaian_pdiri.php";
    public static final String url_cari3 = Server.URL + "penilaian_pantarol.php";

    public static final String url_update = Server.URL + "penilaian_update_observasi.php";
    public static final String url_update2 = Server.URL + "penilaian_update_pdiri.php";
    public static final String url_update3 = Server.URL + "penilaian_update_pantarol.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_p_sikap);
        ...
        adapter = new AdapterNilaiLisan(DisplayPSikapActivity.this, listData);
        adapter2 = new AdapterNilaiTulisan(DisplayPSikapActivity.this, listData2);
        adapter3 = new AdapterNilaiPenugasan(DisplayPSikapActivity.this, listData3);
...
/*
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DisplayPSikapActivity.this, DasbordNilaiSiswaActivity.class);
