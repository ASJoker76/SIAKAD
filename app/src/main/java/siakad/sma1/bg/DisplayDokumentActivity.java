...
public class DisplayDokumentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_dokument);
    ...
    private void init(String file) {
        ...
        pDialog = new ProgressDialog(DisplayDokumentActivity.this);
