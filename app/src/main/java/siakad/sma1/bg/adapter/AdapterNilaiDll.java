...
public class AdapterNilaiDll extends BaseAdapter{
    ...
    public AdapterNilaiDll(Activity activity, List<DataModel> item) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            convertView = inflater.inflate(R.layout.list_nilai4, null);
