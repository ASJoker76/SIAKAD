...
public class AdapterNilaiTulisan extends BaseAdapter{
    ...
    public AdapterNilaiTulisan(Activity activity, List<DataModel> item) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            convertView = inflater.inflate(R.layout.list_nilai2, null);
